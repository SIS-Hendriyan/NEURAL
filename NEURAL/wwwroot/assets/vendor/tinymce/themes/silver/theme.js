...
(function () {
    ...
    const defaultMenus = {
      ...
      insert: {
        title: 'Insert',
        items: 'image link media addcomment pageembed NEURAL codesample inserttable | charmap emoticons hr | pagebreak nonbreaking anchor tableofcontents footnotes | mergetags | insertdatetime'
      },
      format: {
        title: 'Format',
